package com.github.mizhicn.mallshop.order;
...
public interface OrderService {
    ...
    CommonResult<OrderItemBO> getOrderItems(Integer oderId);
     ...
     * @return
     */
    CommonResult<OrderRecipientBO> getOrderRecipientBO(Integer oderId);
